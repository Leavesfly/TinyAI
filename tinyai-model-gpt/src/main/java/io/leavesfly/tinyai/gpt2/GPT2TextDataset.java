...
public class GPT2TextDataset extends DataSet {
    ...
    public List<Batch> getBatches() {
        ...
        for (int batchIdx = 0; batchIdx < totalBatches; batchIdx++) {
            ...
            NdArray inputSequences = NdArray.of(Shape.of(actualBatchSize, maxSeqLength));
            NdArray targetSequences = NdArray.of(Shape.of(actualBatchSize, maxSeqLength));
    ...
    public Batch createGenerationBatch(String prompt) {
        ...
        NdArray inputSequence = NdArray.of(Shape.of(1, maxSeqLength));
     ...
     * @return Token序列列表
     */
    public List<int[]> getTokenSequences() {
        return new ArrayList<>(tokenSequences);
    }
