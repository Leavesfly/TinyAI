...
public class ProprioceptionInput {
    ...
    public String toString() {
        return "ProprioceptionInput{" +
                "jointPositionsShape=" + (jointPositions != null ? java.util.Arrays.toString(jointPositions.getShape()) : "null") +
                ", jointVelocitiesShape=" + (jointVelocities != null ? java.util.Arrays.toString(jointVelocities.getShape()) : "null") +
